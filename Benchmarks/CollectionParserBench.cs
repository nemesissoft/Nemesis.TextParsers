...
|------------------------------- |------------:|-------:|---------:|--------:|----------:|
|             SlowSerializerTest | 3,380.50 us | 104.91 | 308.5938 | 35.1563 | 1953629 B |
|                StringSplitTest |    34.65 us |   1.08 |   6.3477 |  0.7324 |   39952 B |
|        StringSplitTestNaïveWay |   315.41 us |   9.80 |  16.1133 |  1.4648 |  103953 B |
|     StringSplitTestNaïveWayOpt |    84.33 us |   2.62 |  10.1318 |  1.2207 |   63992 B |

|                      SpanSplit |    21.93 us |   0.68 |        - |       - |         - |
|                   SpanTokenize |    32.20 us |   1.00 |        - |       - |         - |
|             SpanTokenize_Alloc |    35.49 us |   1.10 |   0.6104 |       - |    4024 B |

|           SequenceReader_Split |    24.29 us |   0.75 |        - |       - |         - |
|        SequenceReader_Tokenize |    23.95 us |   0.74 |        - |       - |         - |
|   SequenceReader_TokenizeAlloc |    24.94 us |   0.77 |   0.6409 |       - |    4024 B |
| SpanCollectionSerializer_Parse |    63.21 us |   1.96 |   0.6104 |       - |    4024 B |
|                 GetTransformer |    63.61 us |   1.97 |   0.6104 |       - |    4088 B |
*/
    [MemoryDiagnoser]
