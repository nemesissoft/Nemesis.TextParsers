...
public class MultiKeyDictionaryBench
{
    ...
    private static readonly IEnumerable<(string Client, string Username, string Token)>
        _keys = Enumerable.Range(1, COUNT)
        .Select(i => (
    ...
    private static readonly Dictionary<string, int> _string = BuildStringDict();
    private static readonly Dictionary<Tuple<string, string, string>, int> _tuple = BuildTupleDict();
    private static readonly Dictionary<(string, string, string), int> _valueTuple = BuildValueTupleDict();

    private static Dictionary<string, int> BuildStringDict()
    {
    ...
    private static Dictionary<Tuple<string, string, string>, int> BuildTupleDict()
    {
    ...
    private static Dictionary<(string, string, string), int> BuildValueTupleDict()
    {
    ...
    public int BuildString() => BuildStringDict().Count;

    [BenchmarkCategory("Build"), Benchmark]
    public int BuildTuple() => BuildTupleDict().Count;


    [BenchmarkCategory("Build"), Benchmark]
    public int BuildValueTuple() => BuildValueTupleDict().Count;
